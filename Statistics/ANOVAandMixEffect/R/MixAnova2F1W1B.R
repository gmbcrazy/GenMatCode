rm(list=ls())
library(R.matlab)
Temp1=readMat("C:/Users/lzhang481/ToolboxAndScript/MyGenMat/Statistics/ANOVAandMixEffect/R/R_MixAnova2F1W1B.mat");
...
sink("C:/Users/lzhang481/ToolboxAndScript/MyGenMat/Statistics/ANOVAandMixEffect/R/MixAnova2F1W1B.txt");print(A);sink(); 
