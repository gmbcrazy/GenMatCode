function p_value=DensityDisGroup_WithHartigansTest(DataGroup,DisX,GroupColor,PlotMode,varargin)
...
% % %         end
        ...
        if Param.Normalized==0
           ...
           nboot=1000;
           [dip, p_value(ii), xlow,xup]=HartigansDipSignifTest(m,nboot);
        ...
        plot(repmat(tempMean(ii),1,2),[0 Param.SignY],'color',GroupColor(ii,:));
           ...
           plot(DisX,y,'color',GroupColor(ii,:));hold on;
