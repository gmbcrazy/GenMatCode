...
A = reshape(a,4,20);    % reshape 80-element x vector into 20 columns
B = reshape(b,4,20);    % reshape 80-element y vector into 20 columns
patch(A,B,[1 0 0])      % plot 20 patches based on the columns of A and B
