function [wave_width,wave_std]=wave_width2_plx0608(filename,timerange,wave,valid_stardard,wave_num)
...
[ns_RESULT]=ns_SetLibrary('NeuroExplorerNeuroShareLibrary.dll');
...
%         figure(1);
        width_index(i)=wave_width1(Dataneed(:,i));
%         plot(Dataneed(:,i));hold on
end


width_index(find(width_index==-1))=[];
