function coverage = boxCoverage3(posx, posy, binWidth, boxType, radius)

% TO BE RE-WRITTEN
% so that it uses occupancy map (to be smoothing sensitive)
...
% - coordinates are inversed because x <-> Row and y <-> Col (should not
% influence coverage calcul)
