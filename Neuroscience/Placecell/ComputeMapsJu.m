function ParamTable=ComputeMapsJu(file_name1,file_name2,ParamTable,i);
...
%eval(['save biduleKarimB',num2str(i),' x y t ts']) 
...
map_filename=[file_name2(1:(end-4)) '_occ' num2str(i) '.txt' ];
save(map_filename, 'occ_map', '-ascii'); 
...
%splitDataArray = dataSplit(x, y, t);
...
[map, aMap, xAxis, yAxis, aRowAxis, aColAxis, maxPlotRate, posPDF]=Compute_rate_map(ts,x,y,t,p,i);

map_filename=[file_name2(1:(end-4)) '_rate' num2str(i) '.txt' ];
