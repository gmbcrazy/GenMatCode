...
TFRLuNew=TFRLu;
TFRLuNew.crsspctrm=[];
TFRLuNew.crsspctrm(1,2,:,:)=TFRLu.crsspctrm;
TFRLuNew.crsspctrm(2,1,:,:)=TFRLu.crsspctrm;
TFRLuNew.crsspctrm(1,1,:,:)=TFRLu.powspctrm(1,:,:);
TFRLuNew.crsspctrm(2,2,:,:)=TFRLu.powspctrm(2,:,:);
