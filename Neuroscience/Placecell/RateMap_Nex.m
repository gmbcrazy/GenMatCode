function varargout=RateMap_Nex(filename,cellName,timerange,p)
...
[aMap, rawMap, aRowAxis, aColAxis, timeMap,spikeMap] = rateMap(x,y,spkx,spky,p.binWidth,p.binWidth,Xstart,Ystart,Xend,Yend,p.sampleTime, p);
