function varargout=RateMapAdaptiveShuffle_Nex(filename,cellName,timerange,p,ShuffleNum,ShuffleRange)
...
shape(1)=2;
shape(2)=100;
[aMap{Shufflei}, posPDF{Shufflei}, aRowAxis, aColAxis]  = ratemapAdaptiveSmoothing(x, y, spkx, spky,Xstart,Ystart,Xend,Yend, p.sampleTime,p, shape, Center(1), Center(2));
