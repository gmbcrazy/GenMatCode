...
% % S1Power = waveletLU(LFPtemp,scales,wname,'ntw',ntw,'nsw',nsw);
% [WCOH,WCS,S1Power,S1Power2]=wcoher_newVersion(LFPtemp1,LFPtemp2,scales,wname,'ntw',ntw,'nsw',nsw);
% [WCOH,WCS,S1Power,S1Power2]=wcoherLU(LFPtemp1,LFPtemp2,scales,wname,'ntw',ntw,'nsw',nsw);
[WCOH,WCS,S1Power,S1Power2]=wcoher_newVersion2(LFPtemp1,LFPtemp2,scales,wname,bin_width,'nsw',nsw);%%%%'SAM' refers to sampling rate;
