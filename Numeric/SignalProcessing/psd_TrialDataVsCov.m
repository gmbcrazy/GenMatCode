function [SxxSpec,w,options,ValidIndex,WinNum]=psd_TrialDataVsCov(Data1,Cov,CovBin,psdParameter)


ValidIndex=1:length(Data1);
SxxSpec=zeros(psdParameter.nfft,length(CovBin)-1);
...
[yy,nbin]= aveY_discretizeX(temp2',CovSxxT,CovBin);
% SxxSpec(:,:,i)=yy';
