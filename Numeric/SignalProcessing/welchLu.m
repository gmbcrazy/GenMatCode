function varargout = welchLu(x,ts_start,IntervalRemove,esttype,varargin)
...
switch esttype,
    case {'ms','psd'},
        for i = 1:k,
            ...
            [Sxxk,w] = computeperiodogram(temp1,win,...
    ...
    case 'tfe'
        ...
        for i = 1:k,
            ...
            [Syxk,w] = computeperiodogram({temp2,...
                temp1},win,options.nfft,esttype,options.Fs);
            Sxx  = Sxx + Sxxk;          
            Sxy  = Sxy + Syxk;
        end
