...
% template Application M-file for template.fig
%    FIG = template launch template GUI.
%    template('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.5 21-Oct-2004 15:17:02
...
% --------------------------------------------------------------------
function varargout = T1Click_Callback(h, eventdata, handles, varargin)
...
for i=1:handles.RawData.chnno
    ...
    if selmark==0
        ...
        if isempty(N) & hpsetting==1 %there is no filtering.
            handles.ResultData.coef(:,i)=abs(handles.RawData.data(stp:endp,handles.AnaData.selfirstchn(selmark)));
        else
            ...
            handles.ResultData.coef(:,i)=abs(synres(:));
        end
    end
end
...
tmp_filename=strcat(tmp_filename,'-REC.txt');
...
function leftbuttonfile_CreateFcn(hObject, eventdata, handles)
% hObject    handle to leftbuttonfile (see GCBO)
...
function leftbuttonfile_Callback(hObject, eventdata, handles)
% hObject    handle to leftbuttonfile (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of leftbuttonfile as text
%        str2double(get(hObject,'String')) returns contents of leftbuttonfile as a double


% --- Executes on button press in TemplateLButton.
function TemplateLButton_Callback(hObject, eventdata, handles)
% hObject    handle to TemplateLButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in TemplateRButton.
function TemplateRButton_Callback(hObject, eventdata, handles)
% hObject    handle to TemplateRButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes during object creation, after setting all properties.
function rightbuttonfilename_CreateFcn(hObject, eventdata, handles)
% hObject    handle to rightbuttonfilename (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function rightbuttonfilename_Callback(hObject, eventdata, handles)
% hObject    handle to rightbuttonfilename (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of rightbuttonfilename as text
%        str2double(get(hObject,'String')) returns contents of rightbuttonfilename as a double


% --- Executes during object creation, after setting all properties.
function leftopenarrow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to leftopenarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function leftopenarrow_Callback(hObject, eventdata, handles)
% hObject    handle to leftopenarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of leftopenarrow as text
%        str2double(get(hObject,'String')) returns contents of leftopenarrow as a double


% --- Executes during object creation, after setting all properties.
function rightopenarrow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to rightopenarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function rightopenarrow_Callback(hObject, eventdata, handles)
% hObject    handle to rightopenarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of rightopenarrow as text
%        str2double(get(hObject,'String')) returns contents of rightopenarrow as a double


% --- Executes during object creation, after setting all properties.
function leftsolidarrow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to leftsolidarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function leftsolidarrow_Callback(hObject, eventdata, handles)
% hObject    handle to leftsolidarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of leftsolidarrow as text
%        str2double(get(hObject,'String')) returns contents of leftsolidarrow as a double


% --- Executes during object creation, after setting all properties.
function rightsolidarrow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to rightsolidarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function rightsolidarrow_Callback(hObject, eventdata, handles)
% hObject    handle to rightsolidarrow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of rightsolidarrow as text
%        str2double(get(hObject,'String')) returns contents of rightsolidarrow as a double
...
% --- Executes during object creation, after setting all properties.
function T1MinLevel_CreateFcn(hObject, eventdata, handles)
% hObject    handle to T1MinLevel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function T1MinLevel_Callback(hObject, eventdata, handles)
% hObject    handle to T1MinLevel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of T1MinLevel as text
%        str2double(get(hObject,'String')) returns contents of T1MinLevel as a double


% --- Executes on button press in T2BiClick.
function T2BiClick_Callback(hObject, eventdata, handles)
% hObject    handle to T2BiClick (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes during object creation, after setting all properties.
function T2MinLevel_CreateFcn(hObject, eventdata, handles)
% hObject    handle to T2MinLevel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function T2MinLevel_Callback(hObject, eventdata, handles)
% hObject    handle to T2MinLevel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of T2MinLevel as text
%        str2double(get(hObject,'String')) returns contents of T2MinLevel as a double


% --- Executes on button press in T3GoNotGo.
function T3GoNotGo_Callback(hObject, eventdata, handles)
% hObject    handle to T3GoNotGo (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes during object creation, after setting all properties.
function T3MinLevel_CreateFcn(hObject, eventdata, handles)
% hObject    handle to T3MinLevel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function T3MinLevel_Callback(hObject, eventdata, handles)
% hObject    handle to T3MinLevel (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of T3MinLevel as text
%        str2double(get(hObject,'String')) returns contents of T3MinLevel as a double
