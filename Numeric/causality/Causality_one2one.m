function Causality=Causality_one2one(path_filename,Data_name,timerange,MORDER_band,NFFT,fre_band,fs)
...
[Data(1,:),time]=rate_histogram(path_filename,Data_name(1).Name,timerange,1/fs,1/fs);
[Data(2,:),time]=rate_histogram(path_filename,Data_name(2).Name,timerange,1/fs,1/fs);
% 
