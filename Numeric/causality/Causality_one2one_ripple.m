function Causality=Causality_one2one_ripple(path_filename,Data_name,ref_name,timerange,MORDER_band,NFFT,fre_band,fs,range)
...
raster1=reshape(raster1',1,Nr*Nl);
raster2=reshape(raster2',1,Nr*Nl);


Data(1,:)=raster1;Data(2,:)=raster2;
% 
