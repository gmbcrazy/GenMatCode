function Causality=Causality_Condition(path_filename,Data_name,timerange,CausalityParameter)
...
[Data(i,:),time]=rate_histogram_kernel(path_filename,Data_name(i).Name,timerange,1/fs,1/fs,kernel_parameter);
end
